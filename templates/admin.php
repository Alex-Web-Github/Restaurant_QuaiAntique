                    ...
                    <table class="table table-sm table-stripped">
                        ...
                        <tbody class="table-group-divider">
                            <?php foreach ($bookings as $booking) {
                                // Affichera 'Visiteur' pour les utilisateurs non inscrits qui réservent

                                if ($booking->getUserId() == null) {
                                    $idClient = 'Visiteur';
                                } else {
                                    $idClient = $booking->getUserId();
                                }
                            ?>
                                <tr>
                                    ...
                                    <td><?= $idClient ?></td>
                                    <td class="d-grid gap-2 d-md-block">
                                        <a type="button" class="btn btn-outline-primary" href="./updateBooking.php?id=<?= $booking->getId() ?>">
                    ...
                    <table class="table table-sm table-stripped">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Nom</th>
                                <th scope="col">Allergie(s)</th>
                                <th scope="col">Email</th>
                                <th scope="col">Couverts habituels</th>
        ...
        <div class="row mt-5 justify-content-center">
            <div class="col-12 col-lg-10 mt-5 ">
                    ...
                    <table class="table table-sm table-stripped">
                        ...
                        <tbody class="table-group-divider">
                            <?php foreach ($galleries as $gallerie) { ?>
                                <tr>
                                    <th scope="row"><?= $gallerie->getId() ?></th>
                                    <td><?= $gallerie->getName() ?></td>
                                    <td><?= $gallerie->getDescription() ?></td>
                                    <td><?= $gallerie->getFile() ?></td>
                                    <td class="d-grid gap-2 d-md-block">
                                    <td class="d-grid gap-2 d-md-block">
                                        <a type="button" class="btn btn-outline-primary" href="./updateGallery.php?id=<?= $gallerie->getId() ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                            </svg>
                ...
                <div class="d-flex justify-content-between align-items-center py-3">
                    ...
                    <div>
                        <a href="./addGallery.php" class="btn btn-outline-info">Ajouter une image</a>
                    </div>
                </div>
            </div>
        </div>
