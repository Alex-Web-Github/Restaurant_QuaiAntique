  ...
  <nav class="navbar navbar-expand-lg navbar-togglable fixed-top navbar-dark" >
    <div class="container">
      ...
      <a class="navbar-brand d-lg-none" href="./index.php">
        <img src="./assets/img/Logo_Quai-Antique-gold-mini.png" alt="logo restaurant Quai Antique" width="145px" height="35px">
      </a>
      ...
      <div class="navbar-collapse collapse" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          <li class="">
            <a class="btn btn-primary text-white nav-button" href="./booking.php" type="button">Réservation</a>
          </li>
